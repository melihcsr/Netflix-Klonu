...
class TheRain extends StatefulWidget {
  const TheRain({Key? key}) : super(key: key);

  @override
  _TheRainState createState() => _TheRainState();
}

class _TheRainState extends State<TheRain> {
  @override
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("images/therain_banner.jpg"),
                      fit: BoxFit.cover,
                      opacity: 0.4,
                    ),
                  ),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Image.asset("images/foto9.jpeg"),
                  ),
                  Row(
                    children: [
                      Container(
                  ...
                  Wrap(
                    children: [
                      Padding(
                        ...
                        child: Text(
                          "When a young boy vanishes, a small town uncovers a mystery insolving secret experiments. Terrifiying super natural forces and one strange",
