...
class Birinci extends StatefulWidget {
  const Birinci({Key? key}) : super(key: key);

  @override
  _BirinciState createState() => _BirinciState();
}

class _BirinciState extends State<Birinci> {
  @override
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("images/50m2_banner.jpg"),
                      fit: BoxFit.cover,
                      opacity: 0.4,
                    ),
                  ),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Image.asset("images/foto8.png"),
                  ),
                  Row(
                    children: [
                      Container(
